...
function HomePost() {
    ...
    const listpost = [...post].map((post) =>
        <div key={post._id} style={{ textAlign: "right" }}>
                ...
                <div className="row justify-content-center">
                    <div className="col-12">
                        <div className="section-title text-center mb-4 pb-2">
                            ...
                            <p className="text-muted para-desc mx-auto mb-0">جميع المنشورات الموجوده لدينا هي من شركات وهيئات معتمده من هيئه الدواء والغذاء</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div className="card service-wrapper rounded border-0 shadow p-4">
                            ...
                            <div className="content mt-4">
                                ...
                                <p className="text-muted mt-3 mb-0" style={{ "overflow": "hidden", "max-height": "200px", "text-overflow": "ellipsis", "font-size": "15px" }}>{listpost[listpost.length - 1]}</p>
                                <div className="mt-3">
                                    <a href="/posts" className="text-custom"> جميع المنشورات<i className="mdi mdi-chevron-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div className="card service-wrapper rounded border-0 shadow p-4">
                            ...
                            <div className="content mt-4" >
                                ...
                                <p className="text-muted mt-3 mb-0" style={{ "overflow": "hidden", "max-height": "200px", "text-overflow": "ellipsis", "font-size": "15px" }}>{listpost[listpost.length - 3]}.</p>
                                <div className="mt-3">
                                    <a href="/posts" className="text-custom">جميع المنشورات<i className="mdi mdi-chevron-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div className="card service-wrapper rounded border-0 shadow p-4">
                            ...
                            <div className="content mt-4">
                                ...
                                <p className="text-muted mt-3 mb-0" style={{ "overflow": "hidden", "max-height": "200px", "text-overflow": "ellipsis", "font-size": "15px" }}>{listpost[listpost.length - 4]}</p>
                                <div className="mt-3">
                                    <a href="/posts" className="text-custom">جميع المنشورات <i className="mdi mdi-chevron-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div className="card service-wrapper rounded border-0 shadow p-4">
                            ...
                            <div className="content mt-4">
                                ...
                                <p className="text-muted mt-3 mb-0" style={{ "overflow": "hidden", "max-height": "200px", "text-overflow": "ellipsis", "font-size": "15px" }}>{listpost[listpost.length - 5]}</p>
                                <div className="mt-3">
                                    <a href="/posts" className="text-custom">جميع المنشورات <i className="mdi mdi-chevron-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div className="card service-wrapper rounded border-0 shadow p-4">
                            ...
                            <div className="content mt-4">
                                ...
                                <p className="text-muted mt-3 mb-0" style={{ "overflow": "hidden", "max-height": "200px", "text-overflow": "ellipsis", "font-size": "15px" }}>{listpost[listpost.length - 6]}</p>
                                <div className="mt-3">
                                    <a href="/posts" className="text-custom">جميع المنشورات<i className="mdi mdi-chevron-right"></i></a>
                                </div>
                            </div>
