...
export default function AddDrug() {
  ...
  <Form.Label  className="mb-3" > اضافه دواء </Form.Label>
         ...
         <Form.Control type="Number" name='RegisterNo' required  placeholder="رقم تسجيل الدواء " /> </Form.Group>

         <Form.Group className="mb-3" controlId="formBasicName">
         <Form.Control type="text" name='Name' required  placeholder="أسم الدواء " /></Form.Group>

         <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
         <Form.Label>وصف الدواء</Form.Label>
         <Form.Control  required  name="description" as="textarea"  rows={3} /></Form.Group>
